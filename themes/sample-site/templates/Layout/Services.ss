<%--<div class="main-text">--%>
    <%--<div class="grid-container">--%>
        <%--<h2 class="h1"> sample text </h2>--%>
        <%--<p> "here is more detail about esalaflora.......--%>
            <%--ygruruhrhrjrhjrjr ihrihfifhf bifhief fibfifif--%>
            <%--fbiifb fbifbe fbeibfie febieff"</p>--%>
    <%--</div>--%>
<%--</div>--%>
...
<%--<div class="category1">--%>
    <%--<div class="grid-container">--%>
        <%--<div class="grid-x align-center ">--%>
            <%--<div class="cell small-6 medium-4 large-4 align-left">--%>
            <%--<img src="$resourceURL('themes/sample-site/static/images/cms/image1.jpeg') ">--%>
        <%--</div>--%>
            <%--<div class="cell small-6 medium-8 large-8 align-left">--%>
                <%--bcjbcj cncjn fjke fnnke dnjnjcn--%>
            <%--</div>--%>
            <%--<div class="cell small-6 medium-4 large-4">--%>
                <%--<img src="$resourceURL('themes/sample-site/static/images/cms/image2.jpg') ">--%>
            <%--</div>--%>
